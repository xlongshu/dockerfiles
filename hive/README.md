...
- ubuntu
```bash
# 18.04 bionic, java-8, hadoop 2.7.7, hive 2.3.4
...
# 18.04 bionic, java-8, hadoop 2.7.7, hive 1.2.2
...
# 16.04 xenial, java-8, hadoop 2.7.7, hive 2.3.4
